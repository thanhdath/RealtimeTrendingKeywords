...
def crawl_article(driver: webdriver.Chrome, url: str):
    ...
    try:
        title_elm = driver.find_element_by_css_selector('.dt-news__title')
    ...
    try:
        content_elm = driver.find_element_by_css_selector('.dt-news__content')
    ...
    try:
        tag_elms = driver.find_elements_by_css_selector('.dt-news__tag > a')
